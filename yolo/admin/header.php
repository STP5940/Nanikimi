...
?>                              
            ...
            <div class="page-navigation">
                        ...
                        <div class="profile-buttons">
                            <div class="btn-group">                                
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation" class="dropdown-header">CONTROL</li>
                                    <li><a href="../profile.php">โปรไฟร์</a></li>                                    
                                    <li><a href="../support.php">แจ้งปัญหา</a></li>
                                    <li class="divider"></li>
                ...
                <ul class="navigation">
                    ...
                    <li><a href="settings.php"><i class="fa fa-gears"></i> ตั่งค่า</a>
                    <li><a href="logs.php"><i class="fa fa-bars"></i> ประวัติ</a>
                    </li>                    
                </ul>
